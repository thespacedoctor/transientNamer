...
sys.path.insert(0, os.path.abspath('../../transientNamer/transientNamer'))
...
html_theme_options = {
    ...
    'github_repo': 'transientNamer',
    'strap_line': "Python API for reading and caching TNS reports"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/transientNamer/tree/master"

# General information about the project.
now = datetime.now()
now = now.strftime("%Y")
project = u'transientNamer'
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/transientNamer.rst']
modindex_common_prefix = ["transientNamer."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'transientNamer.tex', u'transientNamer Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["transientNamer"]
    allSubpackages += findAllSubpackges(
        pathToPackage="transientNamer"
    )
