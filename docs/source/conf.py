...
htmlhelp_basename = 'transientNamerdoc'
...
man_pages = [
    ('index', 'transientNamer', u'transientNamer Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'transientNamer', u'transientNamer Documentation',
     u'Dave Young', 'transientNamer', 'One line description of project.',
     'Miscellaneous'),
]
...
def generateAutosummaryIndex():
    ...
    import xxxpython - package - namexxx
    import inspect

    allModules = {}
    allClasses = {}

    for name, obj in inspect.getmembers(xxxpython - package - namexxx):
